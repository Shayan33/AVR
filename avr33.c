...
while (1)
      ...
      else if (str[0] == 'o' & str[1] == 'n' & str[2] == '2')   
      {
        PORTB.1 = 1;
        printf("led 2 is 1");
      } 
      
       else if (str[0] == 'o' & str[1] == 'n' & str[2] == '3')
       {
        PORTB.2 = 1;
        printf("led 3 is 1");
      }
      
       else if (str[0] == 'o' & str[1] == 'n' & str[2] == '4')
       {
        PORTB.3 = 1;
        printf("led 4 is 1");
      }
      
       else if (str[0] == 'o' & str[1] == 'f' & str[2] == '1')     
       {
        PORTB.0 = 0;
        printf("led 1 is 0");
      }
      
       else if (str[0] == 'o' & str[1] == 'f' & str[2] == '2')     
       {
        PORTB.1= 0;
        printf("led 2 is 0");
      }
